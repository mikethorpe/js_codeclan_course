...
InstrumentFamilies.prototype.bindEvents = function(){
    ...
    PubSub.subscribe("SelectView:selected-instrument-family-changed", (event) => {
      const familyIndex = event.detail;
      const instrumentFamily = this.getInstrumentFamilyFromIndex(familyIndex);
      PubSub.publish("InstrumentFamilies:instrument-family-selected", instrumentFamily);
  })
}

InstrumentFamilies.prototype.getInstrumentFamilyFromIndex = function(familyIndex){
    return this.instrumentFamilies[familyIndex];
}
